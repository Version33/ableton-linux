...
dragging in Live's own interface, what patch 0093 changes, and how to
verify the fix. Written 2026-08-03 from the diagnosis in issue 122 and
ported after the pointer-gesture stack on 2026-08-12.

## Status

Patch 0093 (`winex11: release stale cursor clipping state when X focus
leaves the process`) is committed in this series. The series applies,
